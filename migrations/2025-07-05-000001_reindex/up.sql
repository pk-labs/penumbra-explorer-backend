...
DROP TABLE IF EXISTS governance_parameters;
DROP TABLE IF EXISTS dex_individual_swap_routes;
DROP TABLE IF EXISTS dex_individual_swaps;
DROP TABLE IF EXISTS dex_batch_swaps;
DROP TABLE IF EXISTS dex_liquidity_positions;
DROP TABLE IF EXISTS explorer_assets;
